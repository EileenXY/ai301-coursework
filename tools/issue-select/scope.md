...
- Repo: - Repo: codepath/pathreview-ai301-fa26-s1 <!-- paste your section's repo from the Unit 1 Check-In page -->
...
I have experience with Python and Java and have worked with backend development, REST APIs, and databases. I want to improve my backend development, debugging, and AI engineering skills. I prefer issues involving Python, Java, APIs,databases, or backend systems, and I would like to avoid frontend-heavy tasks.
